...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example10/shader/dublicate.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example10/shader/dublicate.geom.glsl", &geometrySource);
    glusFileLoadText("shaders/Example10/shader/dublicate.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Clone", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
