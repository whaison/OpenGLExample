...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example11/shader/glass.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example11/shader/glass.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example11/shader/background.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example11/shader/background.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("Binaries/cm_pos_x.tga", &image);
    ...
    glusImageLoadTga("Binaries/cm_neg_x.tga", &image);
    ...
    glusImageLoadTga("Binaries/cm_pos_y.tga", &image);
    ...
    glusImageLoadTga("Binaries/cm_neg_y.tga", &image);
    ...
    glusImageLoadTga("Binaries/cm_pos_z.tga", &image);
    ...
    glusImageLoadTga("Binaries/cm_neg_z.tga", &image);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("EnvironmentMap", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
