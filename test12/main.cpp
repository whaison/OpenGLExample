 ...
 */
static const GLuint g_shadowTextureSize = 2048;
...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example12/shader/rendershadow.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example12/shader/rendershadow.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example12/shader/useshadow.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example12/shader/useshadow.frag.glsl", &fragmentSource);
...
//    glusMatrix4x4Orthof(projectionMatrix, -g_shadowTextureSize/2.0, g_shadowTextureSize/2.0, -g_shadowTextureSize/2.0, g_shadowTextureSize/2.0, 1.0f, 100.0f);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Shadow mapping", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
