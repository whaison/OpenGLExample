...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example13/shader/tessellation.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example13/shader/tessellation.cont.glsl", &controlSource);
    glusFileLoadText("shaders/Example13/shader/tessellation.eval.glsl", &evaluationSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Simple tessellation", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
