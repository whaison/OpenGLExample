 ...
 */
static const char* HEIGHT_MAP = "Binaries/grand_canyon_height.tga";

/**
 * The color map of the terrain.
 */
static const char* COLOR_MAP = "Binaries/grand_canyon_color.tga";

/**
 * The normal map of the terrain. Width and height does not have to be the same but they have to be power of two plus one.
 */
static const char* NORMAL_MAP = "Binaries/grand_canyon_normal.tga";
...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example14/shader/PassOne.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example14/shader/PassOne.geom.glsl", &geometrySource);
    glusFileLoadText("shaders/Example14/shader/PassOne.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example14/shader/PassTwo.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example14/shader/PassTwo.cont.glsl", &controlSource);
    glusFileLoadText("shaders/Example14/shader/PassTwo.eval.glsl", &evaluationSource);
    glusFileLoadText("shaders/Example14/shader/PassTwo.geom.glsl", &geometrySource);
    glusFileLoadText("shaders/Example14/shader/PassTwo.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Terrain", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
