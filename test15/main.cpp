...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example15/shader/Water.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example15/shader/Water.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("Binaries/water_pos_x.tga", &image);
    ...
    glusImageLoadTga("Binaries/water_neg_x.tga", &image);
    ...
    glusImageLoadTga("Binaries/water_pos_y.tga", &image);
    ...
    glusImageLoadTga("Binaries/water_neg_y.tga", &image);
    ...
    glusImageLoadTga("Binaries/water_pos_z.tga", &image);
    ...
    glusImageLoadTga("Binaries/water_neg_z.tga", &image);
...
GLUSboolean update(GLUSfloat time)
{
    ...
    glusMatrix4x4LookAtf(g_viewMatrix, 0.0f, 1.0f, 0.0f, (GLfloat) 1.5f * sinf(angle), 1.0f, -(GLfloat) 1.5f * cosf(angle), 0.0f, 1.0f, 0.0f);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Water Rendering", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
