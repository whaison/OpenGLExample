...
GLUSuint initWaterTexture(GLUSfloat waterPlaneLength)
{
    ...
    glusFileLoadText("shaders/Example15/shader/WaterTexture.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example15/shader/WaterTexture.frag.glsl", &fragmentSource);
