...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example17/shader/phong_clip.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example17/shader/phong_clip.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Clipping planes and two sided rendering", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
