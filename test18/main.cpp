...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example18/shader/phong.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example18/shader/phong.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Using stencil buffer and clipping planes", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
