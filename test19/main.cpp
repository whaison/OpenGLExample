...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example19/shader/basic_proj.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example19/shader/texture_multi_proj.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("Binaries/ice.tga", &image);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Render to texture and planar reflection", TEXTURE_WIDTH, TEXTURE_HEIGHT, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
