...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example02/shader/simple.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example02/shader/red.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Simple Triangle", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
