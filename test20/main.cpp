...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example20/shader/checker.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example20/shader/checker.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Texture matrix, alpha blending and discarding", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
