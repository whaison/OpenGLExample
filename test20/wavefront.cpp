...
GLUSboolean initWavefront(GLUSfloat viewMatrix[16], struct LightProperties* light)
{
    ...
    glusFileLoadText("shaders/Example20/shader/phong.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example20/shader/phong.frag.glsl", &fragmentSource);
    ...
    glusShapeLoadWavefront("Binaries/elephant.obj", &wavefrontObj);
