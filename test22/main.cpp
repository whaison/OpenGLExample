...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example22/shader/color.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example22/shader/color.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example22/shader/shadowvolume.vert.glsl", &vertexSource);
...
//    glusProgramBuildFromSource(&g_programShadowVolume, (const GLUSchar**) &vertexSource.text, 0, 0, (const GLUSchar**) &geometrySource.text, (const GLUSchar**) &fragmentSource.text);
    ...
    glusFileLoadText("shaders/Example22/shader/shadow.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example22/shader/shadow.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Shadow volumes", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
