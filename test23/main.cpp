...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example23/shader/tessellation.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example23/shader/tessellation.cont.glsl", &controlSource);
    glusFileLoadText("shaders/Example23/shader/tessellation.eval.glsl", &evaluationSource);
    glusFileLoadText("shaders/Example23/shader/tessellation.geom.glsl", &geometrySource);
    glusFileLoadText("shaders/Example23/shader/tessellation.frag.glsl", &fragmentSource);
    ...
    // Load the image.
    glusImageLoadTga("Binaries/four_shapes_color.tga", &image);
    ...
    // Load the image.
    glusImageLoadTga("Binaries/four_shapes_normal.tga", &image);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Displacement mapping", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
