...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example24/shader/erode.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example24/shader/erode.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Erode effect using perlin noise", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
