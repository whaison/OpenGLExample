...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example25/shader/ambient_diffuse_texture.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example25/shader/ambient_diffuse_texture.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example25/shader/fur.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example25/shader/fur.geom.glsl", &geometrySource);
    glusFileLoadText("shaders/Example25/shader/fur.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Fur rendering", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
