...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example26/shader/texture.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example26/shader/texture.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example26/shader/ssao.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example26/shader/ssao.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example26/shader/blur.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example26/shader/blur.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("Binaries/wood_texture.tga", &image);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Screen space ambient occlusion (SSAO) (OpenGL 4.1)", TEXTURE_WIDTH, TEXTURE_HEIGHT, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
