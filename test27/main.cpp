...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example27/shader/fullscreen.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example27/shader/texture.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("CPU ray tracing", WIDTH, HEIGHT, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
