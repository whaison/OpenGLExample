...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example28/shader/point_light.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example28/shader/point_light.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example28/shader/deferred_shading.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example28/shader/deferred_shading.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Deferred shading (OpenGL 4.1)", TEXTURE_WIDTH, TEXTURE_HEIGHT, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
