...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example29/shader/brdf.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example29/shader/brdf.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example29/shader/fullscreen.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example29/shader/fullscreen.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example29/shader/background.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example29/shader/background.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("BRDF and IBL rendering (OpenGL 4.1)", SCREEN_WIDTH, SCREEN_HEIGHT, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
