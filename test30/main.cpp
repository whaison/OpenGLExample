...
GLUSboolean init(GLUSvoid)
{
    ...
    GLchar buffer[37] = "doge2/doge2_POS_X_00_s.hdr";
    
    GLint i, k, m;
    
    //
    
    glusFileLoadText("shaders/Example30/shader/brdf.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example30/shader/brdf.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example30/shader/fullscreen.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example30/shader/fullscreen.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example30/shader/background.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example30/shader/background.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Real-Time BRDF and IBL rendering", SCREEN_WIDTH, SCREEN_HEIGHT, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
