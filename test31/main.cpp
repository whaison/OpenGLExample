...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example31/shader/renderdepthmap.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example31/shader/renderdepthmap.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example31/shader/subsurfacescattering.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example31/shader/subsurfacescattering.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Subsurface scattering", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
