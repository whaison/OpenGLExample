...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example32/shader/phong_depth_peel.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example32/shader/phong_depth_peel.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example32/shader/fullscreen_blend.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example32/shader/fullscreen_blend.frag.glsl", &fragmentSource);
    ...
    glusShapeLoadWavefront("Binaries/dragon.obj", &wavefrontObj);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Order independent transparency using depth peeling", SCREEN_WIDTH, SCREEN_HEIGHT, GLUS_FALSE, GLUS_TRUE, eglConfigAttributes, eglContextAttributes, 0))
    {
