...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example34/shader/simple.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example34/shader/red.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Basic usage of program pipeline and separable programs", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
