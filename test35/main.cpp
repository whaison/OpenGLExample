...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example35/shader/offset.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example35/shader/red_green_blue.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Basic usage of program pipeline, separable programs and shader subroutines", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
