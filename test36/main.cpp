...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example36/shader/phong_textured.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example36/shader/phong_textured.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Scene with several models having groups and materials", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
