...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example37/shader/conservative.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example37/shader/conservative.geom.glsl", &geometrySource);
    glusFileLoadText("shaders/Example37/shader/conservative.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Conservative rasterization", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
