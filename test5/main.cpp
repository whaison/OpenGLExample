...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example05/shader/phong.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example05/shader/phong.frag.glsl", &fragmentSource);
    ...
    glusShapeCreateSpheref(&sphere, 1.5f, 64);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Phong", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
