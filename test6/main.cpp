...
{
    GLfloat lightDirection[3] = { 1.0f, 1.0f, 0.5f };
    ...
    glusFileLoadText("shaders/Example06/shader/basic.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example06/shader/texture.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("Binaries/crate.tga", &image);
...
//    glusShapeCreateCubef(&cube, 1.0f);
    glusShapeCreateSpheref(&cube, 1.0, 64);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Texture", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
