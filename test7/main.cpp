...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example07/shader/normmap.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example07/shader/normmap.frag.glsl", &fragmentSource);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("NormalMap", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
