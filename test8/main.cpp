...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example08/shader/cubemap.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example08/shader/cubemap.frag.glsl", &fragmentSource);
    ...
    glusShapeCreatePlanef(&cube, 1.5f);
...
GLUSboolean update(GLUSfloat time)
{
    ...
    glusMatrix4x4RotateRzRxRyf(modelViewMatrix, angle, angle, angle);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("CubeMap", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
