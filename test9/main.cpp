...
GLUSboolean init(GLUSvoid)
{
    ...
    glusFileLoadText("shaders/Example09/shader/particle.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example09/shader/particle.frag.glsl", &fragmentSource);
    ...
    glusFileLoadText("shaders/Example09/shader/update_points.vert.glsl", &vertexSource);
    glusFileLoadText("shaders/Example09/shader/update_points.frag.glsl", &fragmentSource);
    ...
    glusImageLoadTga("Binaries/particle.tga", &image);
...
int main(int argc, char* argv[])
{
    ...
    if (!glusWindowCreate("Particles", 800, 600, GLUS_FALSE, GLUS_FALSE, eglConfigAttributes, eglContextAttributes, 0))
    {
